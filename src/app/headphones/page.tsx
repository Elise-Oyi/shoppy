...
export default function HeadphonesPage() {
  const headphones = products.filter(p => p.category === 'headphones').sort((a, b) => b.new ? 1 : -1);
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 space-y-6 text-center lg:text-left">
              ...
              <p className="text-gray-500">
                Located in East Legon. We have amazing and quality products at incredible prices. Come and check out our shop any day any time.
              </p>
            </div>
